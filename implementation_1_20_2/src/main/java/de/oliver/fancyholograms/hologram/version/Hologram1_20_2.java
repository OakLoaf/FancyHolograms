...
public final class Hologram1_20_2 extends NMSHologram1_19_4 {
        ...
        super(data, new HashMap<>(){
            {
                ...
                put(MappingKeys1_19_4.TEXT_DISPLAY__DATA_LINE_WIDTH_ID, "aN");
                put(MappingKeys1_19_4.TEXT_DISPLAY__DATA_BACKGROUND_COLOR_ID, "aO");
            }
        });
    }
